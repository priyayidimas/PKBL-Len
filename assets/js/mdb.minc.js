                ...
                this.$document.on("click", this.selectors.chips, function (n) {
                    ...
                    if (!e(n.target).is("input, textarea")) {
                        var i = t.$document.find(t.selectors.chip + t.selectors.selectedChip),
                            ...
                            r = i.siblings(t.selectors.chip).length;
                        if (i.length) {
                            var a = n.which === t.keyCodes.backspace,
                                s = n.which === t.keyCodes.delete,
                                l = n.which === t.keyCodes.arrowLeft,
                                u = n.which === t.keyCodes.arrowRight;
                    ...
                    if (n.which === t.keyCodes.enter) return n.preventDefault(), t.addChip(r, {
                        tag: i.val()
                    }, o), void i.val("");
                    var s = n.keyCode === t.keyCodes.arrowLeft || n.keyCode === t.keyCodes.delete,
                        l = "" === i.val();
...
initPhotoSwipeFromDOM(".mdb-lightbox"),
    ...
    var t, n = function () {
        ...
        return _createClass(t, [{
            ...
            value: function () {
                ...
                this.$nativeSelect.parent().find("span.caret").remove(), this.$nativeSelect.parent().find("input").remove(), this.$nativeSelect.unwrap(), e("ul#select-options-" + t).remove()
            }
        }, {
            ...
            value: function () {
                ...
                this.$searchInput = e('<span class="search-wrap ml-2"><div class="md-form mt-0"><input type="text" class="search form-control w-100 d-block" placeholder="' + t + '"></div></span>'), this.$materialOptionsList.append(this.$searchInput)
            }
        }, {
            ...
            value: function () {
                ...
                this.$nativeSelectChildren.each(function (n, i) {
                    ...
                    if (o.is("option")) t.buildSingleOption(o, t.isMultiple ? "multiple" : "");
                        ...
                        var r = e('<li class="optgroup"><span>' + o.attr("label") + "</span></li>");
            ...
            value: function (t, n) {
                var i = t.is(":disabled") ? "disabled" : "",
                    ...
                    r = t.data("icon"),
                    a = t.data("fa") ? '<i class="fa fa-' + t.data("fa") + '"></i>' : "",
                    s = t.attr("class"),
                    l = r ? '<img alt="" src="' + r + '" class="' + s + '">' : "",
                    c = this.isMultiple ? '<input type="checkbox" class="form-check-input" ' + i + "/><label></label>" : "";
                this.$materialOptionsList.append(e('<li class="' + i + " " + o + '">' + l + '<span class="filtrable">' + c + " " + a + " " + t.html() + "</span></li>"))
            }
        }, {
            ...
            value: function () {
                this.$nativeSelect.css({
                    ...
                    padding: "0",
                    "pointer-events": "none"
                }), this.$nativeSelect.attr("style", this.$nativeSelect.attr("style") + " display: inline!important;"), this.$nativeSelect.attr("tabindex", -1), this.$nativeSelect.data("inherit-tabindex", !1)
            }
        }, {
            key: "bindEvents",
            value: function () {
                var t = this;
                new MutationObserver(this._onMutationObserverChange.bind(this)).observe(this.$nativeSelect.get(0), {
                    attributes: !0,
                    childList: !0,
                    characterData: !0,
                    subtree: !0
                }), this.$nativeSelect.parent().find("button.btn-save").on("click", this._onSaveSelectBtnClick), this.$materialSelect.on("focus", this._onMaterialSelectFocus.bind(this)), this.$materialSelect.on("click", this._onMaterialSelectClick.bind(this)), this.$materialSelect.on("blur", this._onMaterialSelectBlur.bind(this)), this.$materialSelect.on("keydown", this._onMaterialSelectKeydown.bind(this)), this.$toggleAll.on("click", this._onToggleAllClick.bind(this)), this.$materialOptionsList.on("mousedown", this._onEachMaterialOptionMousedown.bind(this)), this.$materialOptionsList.find("li:not(.optgroup)").not(this.$toggleAll).each(function (n, i) {
                    e(i).on("click", t._onEachMaterialOptionClick.bind(t, n, i))
            ...
            value: function (t) {
                t.forEach(function (t) {
                    ...
                    !0 !== n.data("stop-refresh") && ("childList" === t.type || "attributes" === t.type && e(t.target).is("option")) && (n.materialSelect("destroy"), n.materialSelect())
                })
            }
        }, {
            ...
            key: "_onHTMLClick",
            value: function (t) {
                e(t.target).closest("#select-options-" + this.uuid).length || this.$materialSelect.trigger("close")
            }
        }, {
            ...
            value: function () {
                ...
                }), this.$nativeSelect.data("stop-refresh", !0), this.$nativeSelect.val(this.valuesSelected), this._triggerChangeOnNativeSelect(), this.$nativeSelect.removeData("stop-refresh")
            }
        }, {
            ...
            value: function () {
                for (var e = "", t = this.valuesSelected.length, n = 0; n < t; n++) {
                    e += ", " + this.$nativeSelect.find("option").eq(this.valuesSelected[n]).text()
                }
                0 === (e = t >= 5 ? t + " options selected" : e.substring(2)).length && (e = this.$nativeSelect.find("option:disabled").eq(0).text()), this.$nativeSelect.siblings("input.select-dropdown").val(e)
            }
        }, {
            key: "_randomUUID",
            value: function () {
    ...
    function () {
        ...
        function S(e, t) {
            var n, o, a = i(C),
                ...
                T = a.find(".clockpicker-am-pm-block"),
                A = "INPUT" === e.prop("tagName"),
                E = A ? e : e.find("input"),
                I = (E.prop("type"), i("label[for=" + E.attr("id") + "]")),
                D = this;
            if (this.id = (o = ++m + "", (n = "cp") ? n + o : o), this.element = e, this.holder = c, this.options = t, this.isAppended = !1, this.isShown = !1, this.currentView = "hours", this.isInput = A, this.input = E, this.label = I, this.popover = a, this.plate = l, this.hoursView = f, this.minutesView = S, this.amPmBlock = T, this.spanHours = a.find(".clockpicker-span-hours"), this.spanMinutes = a.find(".clockpicker-span-minutes"), this.spanAmPm = a.find(".clockpicker-span-am-pm"), this.footer = a.find(".picker__footer"), this.amOrPm = "", t.twelvehour) {
            ...
            if (t.twelvehour)
                for (M = 0; M < 12; M += t.hourstep) O = R.clone(), L = M / 6 * Math.PI, N = y, O.css("font-size", "140%"), O.css({
                    left: v + Math.sin(L) * N - x,
                    top: v - Math.cos(L) * N - x
                }), O.html(0 === M ? 12 : M), f.append(O), O.on(u, H);
            else
                for (M = 0; M < 24; M += t.hourstep) {
                    ...
                    N = F ? b : y, O.css({
                        left: v + Math.sin(L) * N - x,
                        top: v - Math.cos(L) * N - x
                    }), F && O.css("font-size", "120%"), O.html(0 === M ? "00" : M), f.append(O), O.on(u, H)
                }
            var j = Math.max(t.minutestep, 5);
            for (M = 0; M < 60; M += j)
                for (M = 0; M < 60; M += 5) O = R.clone(), L = M / 30 * Math.PI, O.css({
                    left: v + Math.sin(L) * y - x,
                    top: v - Math.cos(L) * y - x
                }), O.css("font-size", "140%"), O.html(g(M)), S.append(O), O.on(u, H);
            ...
            if (l.on(u, function (e) {
                ...
                var W = a.find(".clockpicker-canvas"),
                    $ = p("svg");
                $.setAttribute("class", "clockpicker-svg"), $.setAttribute("width", w), $.setAttribute("height", w);
                var B = p("g");
                B.setAttribute("transform", "translate(" + v + "," + v + ")");
                var V = p("circle");
                ...
                var Y = p("circle");
                Y.setAttribute("class", "clockpicker-canvas-fg"), Y.setAttribute("r", 5), B.appendChild(z), B.appendChild(q), B.appendChild(Y), B.appendChild(V), $.appendChild(B), W.append($), this.hand = z, this.bg = q, this.fg = Y, this.bearing = V, this.g = B, this.canvas = W
            }
            _(this.options.init)
        }
        ...
        S.DEFAULTS = {
            ...
            }, k), n && _(this.options.afterHourSelect)
    ...
    function (e, t) {
        ...
        return function (e, t, n, i) {
            ...
            o.extend(a, i);
            var s, l, c, u, d, h, f, p, g, m, v, y, b, x, w, k, C, S, _, T, A, E, I, D, P, M, O, L, N, R, F, j, H, W, $, B, V, z, q, Y, U, X, K, Q, G, Z, J, ee, te, ne, ie, oe, re, ae, se, le = {
                    x: 0,
                    y: 0
                },
                ce = {
                ...
                Ee = function (e) {
                    ee && (e && (m > r.currItem.fitRatio ? be || (Kt(r.currItem, !1, !0), be = !0) : be && (Kt(r.currItem), be = !1)), Ae(ee, ue.x, ue.y, m))
                },
                Ie = function (e) {
                ...
                Ne = null,
                Re = function () {
                    Ne && (o.unbind(document, "mousemove", Re), o.addClass(e, "pswp--has_mouse"), a.mouseUsed = !0, Se("mouseUsed")), Ne = setTimeout(function () {
                        Ne = null
                    }, 100)
                },
                Fe = function (e, t) {
                ...
                Qe = {
                    ...
                    setScrollOffset: function (e, t) {
                        fe.x = e, R = fe.y = t, Se("updateScrollOffset", fe)
                    },
                    ...
                    init: function () {
                        if (!s && !l) {
                            ...
                            t && (r.ui = new t(r, o)).init(), Se("firstUpdate"), u = u || a.index || 0, (isNaN(u) || 0 > u || u >= Wt()) && (u = 0), r.currItem = Ht(u), (F.isOldIOSPhone || F.isOldAndroid) && (me = !1), e.setAttribute("aria-hidden", "false"), a.modal && (me ? e.style.position = "fixed" : (e.style.position = "absolute", e.style.top = o.getScrollY() + "px")), void 0 === R && (Se("initialLayout"), R = L = o.getScrollY());
                            var c = "pswp--open ";
                            ...
                            N || o.bind(r.scrollWrap, p, r), Ce("initialZoomInEnd", function () {
                                r.setContent(k[0], u - 1), r.setContent(k[2], u + 1), k[0].el.style.display = k[2].el.style.display = "block", a.focus && e.focus(), o.bind(document, "keydown", r), F.transform && o.bind(r.scrollWrap, "click", r), a.mouseUsed || o.bind(document, "mousemove", Re), o.bind(window, "resize scroll", r), Se("bindEvents")
                    ...
                    close: function () {
                        s && (s = !1, l = !0, Se("close"), o.unbind(window, "resize", r), o.unbind(window, "scroll", g.scroll), o.unbind(document, "keydown", r), o.unbind(document, "mousemove", Re), F.transform && o.unbind(r.scrollWrap, "click", r), z && o.unbind(window, f, r), Se("unbindEvents"), $t(r.currItem, null, !0, r.destroy))
                    },
                    destroy: function () {
                    ...
                    goTo: function (e) {
                        var t = (e = we(e)) - u;
                        ge = t, u = e, r.currItem = Ht(u), he -= t, Pe(pe.x * he), Xe(), te = !1, r.updateCurrItem()
                    },
                    next: function () {
                        r.goTo(u + 1)
                    },
                    ...
                    updateCurrItem: function (e) {
                        if (0 !== ge) {
                            var t, n = Math.abs(ge);
                            if (!(e && 2 > n)) {
                                r.currItem = Ht(u), be = !1, Se("beforeChange", ge), n >= 3 && (h += ge + (ge > 0 ? -3 : 3), n = 3);
                                ...
                                if (ee && 1 === Math.abs(ge)) {
                                    var o = Ht(C);
                                    o.initialZoomLevel !== m && (qt(o, de), Kt(o), Ie(o))
                                }
                    ...
                    updateSize: function (t) {
                        ...
                        if (de.x = r.scrollWrap.clientWidth, de.y = r.scrollWrap.clientHeight, Ve(), pe.x = de.x + Math.round(de.x * a.spacing), pe.y = de.y, Pe(pe.x * he), Se("beforeResize"), void 0 !== h) {
                            for (var i, s, l, c = 0; 3 > c; c++) i = k[c], De((c + h) * pe.x, i.el.style), l = u + c - 1, a.loop && Wt() > 2 && (l = we(l)), (s = Ht(l)) && (w || s.needsUpdate || !s.bounds) ? (r.cleanSlide(s), r.setContent(i, l), 1 === c && (r.currItem = s, r.updateCurrZoomItem(!0)), s.needsUpdate = !1) : -1 === i.index && l >= 0 && r.setContent(i, l), s && s.container && (qt(s, de), Kt(s), Ie(s));
                            w = !1
                        }
                        v = m = r.currItem.initialZoomLevel, (J = r.currItem.bounds) && (ue.x = J.center.x, ue.y = J.center.y, Ee(!0)), Se("resize")
                    },
                ...
                _t = function (e, t) {
                    var n, i, o, s, l = ue[e] + t[e],
                        ...
                        u = ct.x + t.x,
                        d = ct.x - it.x;
                    return n = l > J.min[e] || l < J.max[e] ? a.panEndFriction : 1, l = ue[e] + t[e] * n, !a.allowPanToNext && m !== r.currItem.initialZoomLevel || (ee ? "h" !== ne || "x" !== e || Y || (c ? (l > J.min[e] && (n = a.panEndFriction, J.min[e], i = J.min[e] - ce[e]), (0 >= i || 0 > d) && Wt() > 1 ? (s = u, 0 > d && u > it.x && (s = it.x)) : J.min.x !== J.max.x && (o = l)) : (l < J.max[e] && (n = a.panEndFriction, J.max[e], i = ce[e] - J.max[e]), (0 >= i || d > 0) && Wt() > 1 ? (s = u, d > 0 && u < it.x && (s = it.x)) : J.min.x !== J.max.x && (o = l))) : s = u, "x" !== e) ? void(te || K || m > r.currItem.fitRatio && (ue[e] += t[e] * n)) : (void 0 !== s && (Pe(s, !0), K = s !== it.x), J.min.x !== J.max.x && (void 0 !== o ? ue.x = o : K || (ue.x += t.x * n)), void 0 !== s)
                },
                Tt = function (e) {
                    if (!("mousedown" === e.type && e.button > 0)) {
                        ...
                        if (!V || "mousedown" !== e.type) {
                            ...
                            var n = St(e),
                                i = n.length;
                            Q = null, Xe(), z && 1 !== i || (z = ie = !0, o.bind(window, f, r), $ = ae = oe = B = K = U = q = Y = !1, ne = null, Se("firstTouchStart", n), Oe(ce, ue), le.x = le.y = 0, Oe(et, n[0]), Oe(tt, et), it.x = pe.x * he, ot = [{
                                x: et.x,
                                y: et.y
                            }], H = j = _e(), Fe(m, !0), ft(), pt()), !G && i > 1 && !te && !K && (v = m, Y = !1, G = q = !0, le.y = le.x = 0, Oe(ce, ue), Oe(Ge, n[0]), Oe(Ze, n[1]), bt(Ge, Ze, dt), ut.x = Math.abs(dt.x) - ue.x, ut.y = Math.abs(dt.y) - ue.y, Z = ht(Ge, Ze))
                        }
                    }
                },
                At = function (e) {
                ...
                Et = function () {
                    if (Q) {
                        var e = Q.length;
                        if (0 !== e)
                            if (Oe(Ge, Q[0]), Je.x = Ge.x - et.x, Je.y = Ge.y - et.y, G && e > 1) {
                                ...
                                0 > i && (i = 0), bt(Ge, Ze, st), le.x += st.x - dt.x, le.y += st.y - dt.y, Oe(dt, st), ue.x = Me("x", n), ue.y = Me("y", n), $ = n > m, m = n, Ee()
                            } else {
                                if (!ne) return;
                                ...
                                if ("v" === ne && a.closeOnVerticalDrag && "fit" === a.scaleMode && m === r.currItem.initialZoomLevel) {
                                    le.y += Je.y, ue.y += Je.y;
                                    var c = xt();
                                    return B = !0, Se("onVerticalDrag", c), Te(c), void Ee()
                                }(function (e, t, n) {
                                    if (e - H > 50) {
                                        var i = ot.length > 2 ? ot.shift() : {};
                                        i.x = t, i.y = n, ot.push(i), H = e
                                    }
                                })(_e(), Ge.x, Ge.y), U = !0, J = r.currItem.bounds, _t("x", Je) || (_t("y", Je), Le(ue), Ee())
                            }
                    }
                },
                It = function (e) {
                    ...
                    if (0 === l && (z = !1, o.unbind(window, f, r), ft(), G ? c = 0 : -1 !== lt && (c = _e() - lt)), lt = 1 === l ? _e() : -1, i = -1 !== c && 150 > c ? "zoom" : "swipe", G && 2 > l && (G = !1, 1 === l && (i = "zoomPointerUp"), Se("zoomGestureEnded")), Q = null, U || Y || te || B)
                        if (Xe(), W || (W = Dt()), W.calculateSwipeSpeed("x"), B)
                            if (xt() < a.verticalDragRange) r.close();
                            else {
                                var u = ue.y,
                                    d = re;
                                Ke("verticalDrag", 0, 1, 300, o.easing.cubic.out, function (e) {
                                    ue.y = (r.currItem.initialPosition.y - u) * e + u, Te((1 - d) * e + d), Ee()
                                }), Se("onVerticalDrag", 1)
                            }
                    else {
                        if ((K || te) && 0 === l) {
                        ...
                        if (!te) return "swipe" !== i ? void Lt() : void(!K && m > r.currItem.fitRatio && Pt(W))
                    }
                },
                Dt = function () {
                    var e, t, n = {
                ...
                Lt = function () {
                    ...
                    t > m ? e = t : m > n && (e = n);
                    var i, a = re;
                    return oe && !$ && !ae && t > m ? (r.close(), !0) : (oe && (i = function (e) {
                        Te((1 - a) * e + a)
            ...
            var Nt, Rt, Ft, jt, Ht, Wt, $t = function (t, n, i, s) {
                    var l;
                    ...
                    if (!d || !l || void 0 === l.x) return Se("initialZoom" + (i ? "Out" : "In")), m = t.initialZoomLevel, Oe(ue, t.initialPosition), Ee(), e.style.opacity = i ? 0 : 1, Te(1), void(d ? setTimeout(function () {
                        h()
                    }, d) : h());
                    ! function () {
                        var n = c,
                            s = !r.currItem.src || r.currItem.loadError || a.showHideOpacity;
                        t.miniImg && (t.miniImg.style.webkitBackfaceVisibility = "hidden"), i || (m = l.w / t.w, ue.x = l.x, ue.y = l.y - L, r[s ? "template" : "bg"].style.opacity = .001, Ee()), Ue("initialZoom"), i && !n && o.removeClass(e, "pswp--animated-in"), s && (i ? o[(n ? "remove" : "add") + "Class"](e, "pswp--animate_opacity") : setTimeout(function () {
                            ...
                            if (Se("initialZoom" + (i ? "Out" : "In")), i) {
                                var r = l.w / t.w,
                                    ...
                                    u = re,
                                    f = function (t) {
                                        1 === t ? (m = r, ue.x = l.x, ue.y = l.y - R) : (m = (r - c) * t + c, ue.x = (l.x - a.x) * t + a.x, ue.y = (l.y - R - a.y) * t + a.y), Ee(), s ? e.style.opacity = 1 - t : Te(u - t * u)
                                    };
                                n ? Ke("initialZoom", 0, 1, d, o.easing.cubic.out, f, h) : (f(1), Nt = setTimeout(h, d + 20))
                            } else m = t.initialZoomLevel, Oe(ue, t.initialPosition), Ee(), Te(1), s ? e.style.opacity = 1 : Te(1), Nt = setTimeout(h, d + 20)
                        }, i ? 25 : 90)
                    }()
                },
                Bt = {},
            ...
            xe("Controller", {
                publicMethods: {
                    ...
                    initController: function () {
                        o.extend(a, zt, !0), r.items = Rt = n, Ht = r.getItemAt, Wt = a.getNumItemsFn, a.loop, Wt() < 3 && (a.loop = !1), Ce("beforeChange", function (e) {
                            var t, n = a.preload,
                                i = null === e || e >= 0,
                                o = Math.min(n[0], Wt()),
                                s = Math.min(n[1], Wt());
                    ...
                    setContent: function (e, t) {
                        ...
                        if (l) {
                            ...
                            Ft || t !== u ? Ie(l) : (ee = c.style, $t(l, i || l.img)), e.el.innerHTML = "", e.el.appendChild(c)
                        } else e.el.innerHTML = ""
                    },
            ...
            xe("Tap", {
                ...
                publicMethods: {
                    ...
                    handleMouseWheel: function (e) {
                        if (m <= r.currItem.fitRatio) return a.modal && (!a.closeOnScroll || qe || z ? e.preventDefault() : E && Math.abs(e.deltaY) > 2 && (c = !0, r.close())), !0;
    ...
    function (e, t) {
        ...
        "use strict";
        return function (e, t) {
            var n, i, o, r, a, s, l, c, u, d, h, f, p, g, m, v, y, b, x = this,
                w = !1,
                k = !0,
                C = !0,
                S = {
            ...
            x.init = function () {
                t.extend(e.options, S, !0), m = e.options, i = t.getChildByClass(e.scrollWrap, "pswp__ui"), d = e.listen,
                    function () {
                        var e;
                        ...
                        C || D(), y && clearInterval(y), t.unbind(document, "mouseout", R), t.unbind(document, "mousemove", N), t.unbind(i, "pswpTap click", _), t.unbind(e.scrollWrap, "pswpTap", x.onGlobalTap), t.unbind(e.scrollWrap, "mouseover", x.onMouseOver), n && (t.unbind(document, n.eventK, x.updateFullscreen), n.isFullscreen() && (m.hideAnimationDuration = 0, n.exit()), n = null)
                    }), d("destroy", function () {
